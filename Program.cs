    ...
    class prgram
    {
        public static void Main(String[] args)
        {
            ...
            for (int i = 0; i < data.typesOfPulse.Count; i++)
            {
                ...
                int price = data.typesOfPulse[i].weight * data.typesOfPulse[i].price;
                Console.WriteLine("Price of {0} for {1}kg is {2}: ", data.typesOfPulse[i].name, data.typesOfPulse[i].weight, price);
